...
| Current Phase | Recall breadth, semantic separation 및 cross-media type balance 검증 |
| Product Status | Recommendation Architecture v2.7 Adaptive Recall과 Cross-media type coverage 구현 완료 |
...
| Recommendation Architecture | In progress | v2.7 Adaptive Recall, 타입별 List/Detail 배분, Cross-media Seed coverage 적용 |
| Recommendation QA | In progress | 100개 Deterministic Dataset과 확장 Live Cold/Warm 검증, Founder 제품 QA 대기 |
| Operating Standards | Complete | Founder Preview readiness와 CODEX_QA_PROTOCOL v1.1.0 증거 기반 QA gate 적용 |
