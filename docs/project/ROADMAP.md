...
| Product Status | Recommendation Architecture v2.0 후보 파이프라인 검증 중 |
| Release Status | Founder 로컬 TMDB 품질 QA 대기 |
...
| Recommendation Architecture | In progress | Candidate Collection, hard constraint, tier, Weight ranking 연결 완료 |
| Recommendation QA | In progress | 15개 QA Dataset, evaluator 확장, Founder TMDB 측정 대기 |
...
| v2.1 | Metadata-aware Scoring | keyword, director, actor, language, freshness, diversity 고도화 |
