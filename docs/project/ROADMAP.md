...
| Product Status | Recommendation Architecture v2.6 Submitted Snapshot 및 콘텐츠 타입/OTT/런타임 Hard Filter 보강 완료 |
| Release Status | 81-case deterministic, 49-case Live Cold/Warm 기술 PASS, Founder 제품 QA 대기 |
...
| Recommendation Architecture | In progress | v2.6 Submitted Session, Provider 타입 분리, OTT/런타임 Hard Filter 적용 |
| Recommendation QA | In progress | 81개 QA Dataset과 49개 Live Cold/Warm 검증, Founder UX QA 대기 |
| Operating Standards | In progress | Founder Preview failure propagation, multi-clone runtime isolation, Founder QA readiness gate 적용 |
...
| v2.7 | Metadata-aware Scoring | keyword, director, actor, language, freshness, diversity 고도화 |
