...
| Current Phase | Candidate integrity, QA Dataset, Weight Engine 연결 |
| Product Status | Recommendation Architecture v2.5 TV Semantic Recall 및 한국어 표시 정합성 보강 완료 |
| Release Status | 60-case deterministic, 42-case Live Cold/Warm 기술 PASS, Founder 제품 QA 대기 |
...
| Recommendation Architecture | In progress | v2.5 Filtering/Scoring 분리, controlled combined, Canonical presentation 적용 |
| Recommendation QA | In progress | 60개 QA Dataset과 42개 Live Cold/Warm 검증, Founder UX QA 대기 |
| Operating Standards | In progress | AI 운영 기준과 Persistent Founder Preview lifecycle/Port governance 표준화 |
...
| Founder Preview 수동 생명주기 | Codex 작업별 Server 누적, Build 후 3000 미복구, QA 주소 불일치 위험 | 3000 고정 Preview와 preflight/finalize/safe check 자동화 완료 |
...
| v2.6 | Metadata-aware Scoring | keyword, director, actor, language, freshness, diversity 고도화 |
...
| Local Runtime | 3000 Founder Preview, 3001-3100 임시 Port, ownership-safe cleanup을 공통 운영 |
