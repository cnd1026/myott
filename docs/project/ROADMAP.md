...
| Product Status | Recommendation Architecture v2.1 후보 품질 및 TMDB 요청 안정화 완료 |
| Release Status | Live TMDB Dataset 19/19 기술 PASS, Founder 제품 QA 대기 |
...
| Recommendation Architecture | In progress | v2.1 request budget, progressive fetching, exact ratio, seed scoring 연결 완료 |
| Recommendation QA | In progress | 20개 QA Dataset과 deterministic/live runner 구축, Founder TMDB 측정 대기 |
...
| v2.2 | Metadata-aware Scoring | keyword, director, actor, language, freshness, diversity 고도화 |
