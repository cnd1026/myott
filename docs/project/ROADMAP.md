...
| Product Status | Recommendation Architecture v2.4 Genre Taxonomy 및 Semantic Pair 분류 완료 |
| Release Status | 48-case deterministic, 35-case Live Cold/Warm 기술 PASS, Founder 제품 QA 대기 |
...
| Recommendation Architecture | In progress | v2.4 Provider evidence와 Canonical/Combined/Semantic taxonomy 분리 완료 |
| Recommendation QA | In progress | 48개 QA Dataset과 fixed/live/browser taxonomy 검증, Founder UX QA 대기 |
...
| v2.5 | Metadata-aware Scoring | keyword, director, actor, language, freshness, diversity 고도화 |
