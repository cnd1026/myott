...
| Product Status | Recommendation Architecture v2.3 Adaptive Seed Resolution 및 Unified Genre Contract 완료 |
| Release Status | Live TMDB Cold/Warm Dataset 24/24 기술 PASS, Founder 제품 QA 대기 |
...
| Recommendation Architecture | In progress | v2.3 unified genre taxonomy, confirmed Seed, adaptive search scheduling 연결 완료 |
| Recommendation QA | In progress | 31개 QA Dataset과 deterministic/live cold/warm/browser 검증, Founder UX QA 대기 |
...
| v2.4 | Metadata-aware Scoring | keyword, director, actor, language, freshness, diversity 고도화 |
