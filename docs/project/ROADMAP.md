...
| Product Status | Recommendation Architecture v2.2 Shared Multi-Seed Action 및 TMDB 요청 안정화 완료 |
| Release Status | Live TMDB Cold/Warm Dataset 22/22 기술 PASS, Founder 제품 QA 대기 |
...
| Recommendation Architecture | In progress | v2.2 shared context, action deadline, progressive multi-seed scheduling 연결 완료 |
| Recommendation QA | In progress | 24개 QA Dataset과 deterministic/live cold/warm runner 구축, Founder UX QA 대기 |
...
| v2.3 | Metadata-aware Scoring | keyword, director, actor, language, freshness, diversity 고도화 |
