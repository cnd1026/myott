...
| MYOTT-S08-T10F | Task 8-10F Recommendation reliability and QA finalization | `TBD` | 콘텐츠 타입별 TMDB 후보 수집 분리, content diversity, Related 클릭/카드 레이아웃, 장르 정렬/SF 라벨/OTT 표시 보강. | 완료 |
