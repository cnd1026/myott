...
| MYOTT-S08-T10A | Task 8-10A Quick Pick UX and option recommendation polish | `TBD` | Quick Pick 검색/Grid/chip label 개선, option-only Provider 추천, Related Picks 독립 strip 분리. | 완료 |
