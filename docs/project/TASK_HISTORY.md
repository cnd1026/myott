...
| MYOTT-S08-T10C | Task 8-10C Recommendation option interaction rule polish | `TBD` | Related Picks drag/swipe UX, 검색 clear button, option group 공통 expand rule, visual polish 적용. | 완료 |
