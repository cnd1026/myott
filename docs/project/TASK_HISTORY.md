...
| MYOTT-S09-006A2C | Submitted Preference Snapshot & Hard Filter Integrity | `이번 커밋` | Submitted Session 고정, Provider/display 타입 분리, KR OTT와 런타임 Hard Filter, Related identity, latest-response gate, 로컬 QA diagnostics, 81-case QA 적용. Founder QA 대기. | 완료 |
