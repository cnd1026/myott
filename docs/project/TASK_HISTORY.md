...
| MYOTT-S08-T07 | Task 8-7 Multi-seed option scoring | `TBD` | 여러 seed 반복, seed genre overlap, Quick Pick, 콘텐츠 타입, TMDB popularity/rating을 반영한 rule-based score 정렬 추가. UI 구조 유지. | 완료 |
