...
- [x] Task F-01 Project Memory System(PMS) 구축
- [x] Task F-02 AI PM Bootstrap System v1.0 문서화
- [x] Task F-03 AI PM Constitution v1.0 작성
- [x] Task F-04 AI PM Behavior 문서 작성
- [x] Task F-05 AI PM Validation 문서 작성

## Current Goal

- 새로운 AI PM이 운영체계를 잘 따르는지 검증하는 체크리스트 작성
- Review, Architecture, Documentation, MVP 보호, Book 연결 평가 기준 정리
- Pass / Fail / Score 방식의 최종 평가 기준 마련
- 다음 단계: TMDB Provider 실제 이전 범위 설계

## Project Memory System

MyOTT는 긴 Sprint와 여러 Codex 스레드를 안정적으로 이어가기 위해 Project Memory System(PMS)을 사용합니다.

- [AI_PM_CONSTITUTION.md](docs/project/AI_PM_CONSTITUTION.md): AI PM이 지켜야 하는 최상위 프로젝트 운영 헌법
- [AI_PM_BEHAVIOR.md](docs/project/AI_PM_BEHAVIOR.md): AI PM이 사용자와 협업할 때 따르는 행동 규칙
- [AI_PM_VALIDATION.md](docs/project/AI_PM_VALIDATION.md): 새로운 AI PM이 운영체계를 따르는지 검증하는 체크리스트
- [AI_PM_BOOTSTRAP.md](docs/project/AI_PM_BOOTSTRAP.md): 새 ChatGPT 채팅에서 첫 번째로 읽는 공식 Bootstrap 문서
