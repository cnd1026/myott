...
- [x] Task 4-4b AI Recommendation Domain 설계 초안
- [x] Task 4-4c User / Session Domain 설계 초안
- [x] Task 4-4d Database Inventory 정리
...
- AI Recommendation Domain 데이터 모델 초안 정리
- User / Session Domain 데이터 모델 초안 정리
- Database Inventory로 테이블 후보 통합
- 다음 단계: TMDB 필드 매핑과 v1.0 최소 테이블 범위 확정
