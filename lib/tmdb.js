...
const TV_HORROR_RETRIEVAL_PLAN = Object.freeze([
  { id: "exact-popularity-page-1", retrievalGenreId: 9648, page: 1, voteCountGte: 30 },
  { id: "exact-rating-page-1", retrievalGenreId: 9648, page: 2, voteCountGte: 5 },
  { id: "exact-breadth-page-2", retrievalGenreId: 9648, page: 3, voteCountGte: 5 },
  { id: "exact-breadth-page-3", retrievalGenreId: 10765, page: 1, voteCountGte: 30 },
  { id: "exact-breadth-page-4", retrievalGenreId: 10765, page: 2, voteCountGte: 5 },
  { id: "exact-breadth-page-5", retrievalGenreId: 80, page: 1, voteCountGte: 30 },
  { id: "exact-breadth-page-6", retrievalGenreId: 80, page: 2, voteCountGte: 5 },
  { id: "exact-breadth-page-7", retrievalGenreId: 18, page: 1, voteCountGte: 30 },
]);
    ...
    if (lineagePoolState) {
      ...
      for (const item of stageCandidates) {
        ...
        if (!lineagePoolState.arrivalStageByCandidateId.has(candidateId)) {
          lineagePoolState.arrivalStageByCandidateId.set(candidateId, stage.id);
        }
      }
    }
